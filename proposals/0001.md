...
Going forward the following recommendations for structuring errors is proposed. An `enum` or a
...
while also preventing the end user from inspecting the error. To demonstrate lets use our previous
